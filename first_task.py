...
linspace_size = 300
w0_linspace = np.linspace(-6, 6, linspace_size)
w1_linspace = np.linspace(-6, 6, linspace_size)
...
plt.plot(max_like_x, max_like_y, label=f'maxlike, w0={max_like_w[0,0]:.2f}, w1={max_like_w[1,0]:.2f}',
         color='orange')
